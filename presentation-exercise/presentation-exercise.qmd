...
p <- ggplot(plot_df, aes(x = unemployment_pct, y = median_usd)) +
  ...
  labs(
    title = "Earnings vs unemployment for recent graduates by major",
    subtitle = "Bubble size shows the number of recent graduates in the major",
    x = "Unemployment rate",
    y = "Median annual earnings",
    caption = "Source: FiveThirtyEight college majors dataset (ACS 2010 to 2012)."
  ) +
